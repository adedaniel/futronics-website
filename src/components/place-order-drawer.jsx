...
export default function PlaceOrderDrawer({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      ...
      <DrawerContent
        ...
        // height={["72%", "72%", "72%", "75%"]}
      >
        <DrawerCloseButton color="white" top={4} right={[4, 8]} />
        ...
        <DrawerBody pt={4} pb={8} color="white" px={["6%", 24]}>
          <form action="submit" onSubmit={onCompleteOrder}>
            <Stack spacing={6}>
              <Flex>
                <Heading>Enter your contact information</Heading>
              </Flex>
                  ...
                  <Stack w="full">
                    ...
                    >
                      {statesInNigeria.map((state, index) => (
                        <Box color="#000" as="option" value={state} key={index}>
                          {state}
                        </Box>
                      ))}
                    </Select>
